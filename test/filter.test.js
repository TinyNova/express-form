...
module.exports = {
    ...
    'filter : entityEncode': function() {
        ...
        const request = { body: { field: "&\"<>hello!" }};
    ...
    'filter : truncate : object': function() {
        const request = { body: { email: { key: '1', length: 100 }}};
