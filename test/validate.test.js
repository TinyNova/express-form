...
module.exports = {
    ...
    'validate : isEmail': function() {
        ...
        for (var i in validEmails) {
            request = { body: { field: validEmails[i] }};
            form(validate("field").isEmail())(request, {});
        ...
        for (var i in badEmails) {
            request = { body: { field: badEmails[i] }};
            form(validate("field").isEmail())(request, {});
    ...
    'validate : isUrl': function() {
        ...
        // Success
        request = { body: { field: "http://www.google.com" }};
        form(validate("field").isUrl())(request, {});
        assert.equal(request.form.errors.length, 0);
    },
    ...
    "validation: custom : async": function(done) {
        const request = { body: { field1: "value1", field2: "value2" }};
    ...
    "validation : custom : async : success : request" : function(done) {
        const request = {
            body: {
                field1: "value1",
                field2: "value2"
        ...
        form(validate("field1").custom(function(value, source, request, callback) {
            process.nextTick(function() {
                assert.strictEqual(value, 'value1');
                assert.strictEqual(request.signedCookies.authenticated, true);
                callbackCalled = true;
                callback(null);
            });
        }))(request, {}, next);
